...
function showMeme(){
    clearAll();
    let randomMeme = randomElement(memes);
    let meme = document.createElement('img');
    meme.setAttribute('src',randomMeme);
    meme.setAttribute('alt','Picture');
    document.querySelector(".meme-content").appendChild(meme);
}
function showJoke(){
    clearAll();
    let randomJoke = randomElement(jokes);
    let joke = document.createElement('p');
    joke.textContent = randomJoke;
    document.querySelector(".joke-content").appendChild(joke);
}
function showQuote(){
  clearAll();
  ...
  let container = document.querySelector(".quote-content");
...
function showRiddle(){
  clearAll();
  let randomRiddle = randomElement(riddles);
  let riddle = document.createElement('p');
  riddle.textContent = randomRiddle.question;
  riddle.setAttribute('id','riddle1');
  let answer = document.createElement('p');
  answer.setAttribute('id','answer1');
  answer.textContent = "- "+randomRiddle.answer;
  answer.hidden = true;
  let container = document.querySelector(".riddle-content");
  container.appendChild(riddle);
  container.appendChild(answer);
}
function showRiddleAnswer(){
    let riddle = document.querySelector("#riddle1");
    ...
    if (riddle && answer.hidden) {
        ...
        window.alert("There is no riddle to reveal answer for.");
    }
}